...
sure_bg = cv.dilate(img, None, iterations=3)
...
markers = peak_local_max(distTrans, 3, threshold_rel=.2)

#Place center points at maxima and dilate
imgCenters = centerImage(distTrans, markers)
imgCenters = cv.dilate(imgCenters, None, iterations=1)
#displayImage(imgCenters)
